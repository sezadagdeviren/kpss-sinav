      ...
      <main className="flex-1 flex overflow-hidden">
        <div className="flex-[1.2] flex flex-col p-6 overflow-hidden border-r border-white/5 bg-slate-900/10">
          ...
          <div className="flex-1 glass-card rounded-[2.5rem] flex items-center justify-center p-8 bg-slate-900/40 relative overflow-hidden group border-white/5">
            ...
            {shouldShowTimer && (
              <div className="absolute bottom-6 right-8 opacity-0 group-hover:opacity-20 transition-opacity text-[10px] font-black text-slate-500 uppercase tracking-widest pointer-events-none">
                KPSS HUB ENGINE v1.0
              </div>
            )}
          </div>
        </div>
              ...
              {['A', 'B', 'C', 'D', 'E'].map(choice => {
                ...
                return (
                  <button
                    ...
                    disabled={show}
                    className={`flex-1 flex items-center justify-center rounded-[1.25rem] font-black text-2xl border transition-all duration-300 active:scale-95 ${
                      show 
